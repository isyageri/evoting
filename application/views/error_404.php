...
.error-page {
  ...
  text-align: center;
  background: #55AAFF;
  background: -moz-linear-gradient(top, #55AAFF 0%, #E7E7E7 100%);
  background: -webkit-gradient(linear, left top, left bottom, color-stop(0%, #55AAFF), color-stop(100%, #E7E7E7));
  background: -webkit-linear-gradient(top, #55AAFF 0%, darkred 100%);
  background: -o-linear-gradient(top, #55AAFF 0%, #E7E7E7 100%);
  background: -ms-linear-gradient(top, #55AAFF 0%, #E7E7E7 100%);
  background: linear-gradient(to bottom, #55AAFF 0%, #E7E7E7 100%);
  filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='$firstColor', endColorstr='$secondColor',GradientType=0 ); }
  .error-page:before {
    width: 63px;
    height: 63px;
    border-radius: 50%;
    box-shadow: 3px 25px 0 5px #55AAFF;
    content: '';
    z-index: -1;
    display: block;
    position: relative;
  ...
  .error-page:after {
    ...
    filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#55AAFF', endColorstr='#55AAFF',GradientType=1 ); }
  .error-page h1 {
...
<body>
	<div class="error-page-wrap">
		<article class="error-page gradient">
			...
			<a href="javascript:history.go(-1)" title="Back to site" class="error-back">back</a>
		</article>
	</div>
</body>
</html>